package com.twq.streaming.pageview;
...
public class JavaPageViewStream {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        JavaStreamingContext ssc =
                new JavaStreamingContext("local[2]",
                        "JavaPageViewStream", Durations.seconds(1),
                        System.getenv("SPARK_HOME"),
                        JavaStreamingContext.jarOfClass(JavaPageViewStream.class.getClass()));
        ...
        // 1、统计每一秒中url被访问的次数
        JavaPairDStream<String, Long> pageCounts =
                pageViewJavaDStream.map(pv -> pv.getUrl()).countByValue();
        ...
        JavaDStream<String> activeUserCount =
                pageViewJavaDStream.window(Durations.seconds(15), Durations.seconds(2))
                        ...
                        .groupByKey()
                        .count()
                        .map(cnt -> "Unique active users: " + cnt);
