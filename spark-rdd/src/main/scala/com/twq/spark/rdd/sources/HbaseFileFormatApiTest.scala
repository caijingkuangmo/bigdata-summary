...
object HbaseFileFormatApiTest {
  ...
  private def readHbaseTableWithOldMRApi(sc: SparkContext, conf: Configuration, tableName: String) = {
  ...
  private def readHbaseTableWithNewMRApi(sc: SparkContext, conf: Configuration, tableName: String) = {
  ...
  private def createTableIfNotExsit(conf: Configuration, tableName: String): Unit = {
  ...
  private def writeHbaseTableWithNewMRApi(sc: SparkContext, tablename: String) = {
  ...
  private def writeHbaseTableWithOldMRApi(sc: SparkContext, conf: Configuration, tablename: String) = {
