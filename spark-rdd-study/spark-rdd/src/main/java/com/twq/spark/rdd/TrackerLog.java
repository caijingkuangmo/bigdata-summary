...
public class TrackerLog extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TrackerLog\",\"namespace\":\"com.twq.spark.rdd\",\"fields\":[{\"name\":\"log_type\",\"type\":\"string\"},{\"name\":\"log_server_time\",\"type\":\"string\"},{\"name\":\"cookie\",\"type\":\"string\"},{\"name\":\"ip\",\"type\":\"string\"},{\"name\":\"url\",\"type\":\"string\"}]}");
  ...
  public static com.twq.spark.rdd.TrackerLog.Builder newBuilder() {
    return new com.twq.spark.rdd.TrackerLog.Builder();
  }
  
  /** Creates a new TrackerLog RecordBuilder by copying an existing Builder */
  public static com.twq.spark.rdd.TrackerLog.Builder newBuilder(com.twq.spark.rdd.TrackerLog.Builder other) {
    return new com.twq.spark.rdd.TrackerLog.Builder(other);
  }
  
  /** Creates a new TrackerLog RecordBuilder by copying an existing TrackerLog instance */
  public static com.twq.spark.rdd.TrackerLog.Builder newBuilder(com.twq.spark.rdd.TrackerLog other) {
    return new com.twq.spark.rdd.TrackerLog.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TrackerLog>
    ...
    private Builder() {
      super(com.twq.spark.rdd.TrackerLog.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.twq.spark.rdd.TrackerLog.Builder other) {
      super(other);
    ...
    private Builder(com.twq.spark.rdd.TrackerLog other) {
            super(com.twq.spark.rdd.TrackerLog.SCHEMA$);
      if (isValidValue(fields()[0], other.log_type)) {
        this.log_type = data().deepCopy(fields()[0].schema(), other.log_type);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'log_type' field */
    public com.twq.spark.rdd.TrackerLog.Builder setLogType(java.lang.CharSequence value) {
    ...
    public com.twq.spark.rdd.TrackerLog.Builder clearLogType() {
      log_type = null;
    ...
    /** Sets the value of the 'log_server_time' field */
    public com.twq.spark.rdd.TrackerLog.Builder setLogServerTime(java.lang.CharSequence value) {
    ...
    public com.twq.spark.rdd.TrackerLog.Builder clearLogServerTime() {
    ...
    /** Sets the value of the 'cookie' field */
    public com.twq.spark.rdd.TrackerLog.Builder setCookie(java.lang.CharSequence value) {
    ...
    public com.twq.spark.rdd.TrackerLog.Builder clearCookie() {
      cookie = null;
    ...
    /** Sets the value of the 'ip' field */
    public com.twq.spark.rdd.TrackerLog.Builder setIp(java.lang.CharSequence value) {
    ...
    public com.twq.spark.rdd.TrackerLog.Builder clearIp() {
      ip = null;
    ...
    /** Sets the value of the 'url' field */
    public com.twq.spark.rdd.TrackerLog.Builder setUrl(java.lang.CharSequence value) {
    ...
    public com.twq.spark.rdd.TrackerLog.Builder clearUrl() {
      url = null;
