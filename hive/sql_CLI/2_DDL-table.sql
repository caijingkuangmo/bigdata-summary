...
LOAD DATA LOCAL INPATH '/home/hadoop-twq/hive-course/pokes.txt' OVERWRITE INTO TABLE pokes;
...
LOAD DATA INPATH 'hdfs://master:9999//user/hadoop-twq/hbase-course/20180506/omneo.csv' OVERWRITE INTO TABLE sensor_row_format;


[ROW FORMAT] : 表示表中每一行的格式，可以取DELIMITED和SERDE两个值
...
LOAD DATA LOCAL INPATH '/home/hadoop-twq/hbase-course/apache-tomcat-9.0.8/logs/localhost_access_log.2018-05-07.txt' OVERWRITE INTO TABLE tomcat_access_log;
...
LOAD DATA LOCAL INPATH '/home/hadoop-twq/hive-course/json_table.json' OVERWRITE INTO TABLE json_table;
...
LOCATION
  'hdfs://master:9999/user/hive/warehouse/sensor.db/sensor_format_text'
TBLPROPERTIES (
...
LOAD DATA INPATH "/user/hadoop-twq/hive-course/parquet" OVERWRITE INTO TABLE sensor_parquet; 
...
LOAD DATA INPATH "/user/hadoop-twq/hive-course/orc" OVERWRITE INTO TABLE sensor_orc;   
...
LOAD DATA INPATH "/user/hadoop-twq/hive-course/avro" OVERWRITE INTO TABLE sensor_avro;  
...
LOAD DATA INPATH "/user/hadoop-twq/hive-course/sequence" OVERWRITE INTO TABLE sensor_sequence;
...
LOAD DATA LOCAL INPATH '/home/hadoop-twq/hive-course/omneo.csv' OVERWRITE INTO TABLE sensor_managed;
TRUNCATE TABLE sensor_managed; //清除表的数据

LOAD DATA INPATH 'hdfs://master:9999/user/hadoop-twq/hive-course/omneo.csv' OVERWRITE INTO TABLE sensor_managed;
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' 
STORED AS TEXTFILE
LOCATION 'hdfs://master:9999/user/hadoop-twq/hive-course/omneo';
...
CREATE VIEW IF NOT EXISTS alert_sensor_view AS SELECT * FROM twq.sensor_external WHERE event_type = 'ALERT';
...
LOAD DATA LOCAL INPATH '/home/hadoop-twq/hive-course/employee.txt' OVERWRITE INTO TABLE employee;
...
LOAD DATA INPATH 'hdfs://master:9999/user/hadoop-twq/hive-course/omneo/20180508' OVERWRITE INTO TABLE sensor_managed_partition PARTITION(year=2018, month=201805, day=20180508);
LOAD DATA INPATH 'hdfs://master:9999/user/hadoop-twq/hive-course/omneo/20180509' OVERWRITE INTO TABLE sensor_managed_partition PARTITION(year=2018, month=201805, day=20180509);

-- 创建一张分区外部表：
hadoop fs -mkdir -p /user/hadoop-twq/hive-course/omneo/year=2018/month=201805/day=20180508
hadoop fs -put omneo.csv /user/hadoop-twq/hive-course/omneo/year=2018/month=201805/day=20180508

hadoop fs -mkdir -p /user/hadoop-twq/hive-course/omneo/year=2018/month=201805/day=20180509
hadoop fs -put omneo.csv /user/hadoop-twq/hive-course/omneo/year=2018/month=201805/day=20180509
...
ALTER TABLE sensor_external_partition ADD PARTITION (year=2018, month=201805, day=20180508) LOCATION '/user/hadoop-twq/hive-course/omneo/year=2018/month=201805/day=20180508';
...
-- recover partition
hadoop fs -mkdir -p /user/hadoop-twq/hive-course/omneo/year=2018/month=201805/day=20180510
hadoop fs -put omneo.csv /user/hadoop-twq/hive-course/omneo/year=2018/month=201805/day=20180510
...
hadoop fs -mkdir /user/hadoop-twq/hive-course/omneo-new
ALTER TABLE sensor_external_partition SET LOCATION "/user/hadoop-twq/hive-course/omneo-new";

SELECT COUNT(*) FROM sensor_external_partition;
ALTER TABLE sensor_external_partition PARTITION (year=2018, month=201805, day=20180508) SET LOCATION "/user/hadoop-twq/hive-course/omneo-new/year=2018/month=201805/day=20180508";
...
ALTER TABLE sensor_external_partition PARTITION (year=2018, month=201805, day=20180509) SET LOCATION "/user/hadoop-twq/hive-course/omneo-new/year=2018/month=201805/day=20180509";
