...
STORED AS PARQUET
LOCATION "/user/hadoop-twq/ncdc/parquet";
...
UPDATE VERSION SET SCHEMA_VERSION='2.3.0', VERSION_COMMENT='Set by MetaStore hadoop-twq@192.168.126.130' where VER_ID=1;
