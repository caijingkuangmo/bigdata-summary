package com.twq.dataset.example.etl
...
/**
  * Created by tangweiqun on 2017/10/17.
  spark-submit  \
	--class com.twq.dataset.example.etl.DeviceDataETL  \
...
object DeviceDataETL {
  def main(args: Array[String]): Unit = {
    ...
    val devideDeviceDF =
      deviceInfoDF.select($"devices".getItem("smoke_co_alarms").alias ("smoke_alarms"),
