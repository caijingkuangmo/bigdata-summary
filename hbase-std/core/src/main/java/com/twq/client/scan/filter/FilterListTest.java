...
public class FilterListTest {
    public static void main(String[] args) throws IOException {
        ...
        try(Connection connection = ConnectionFactory.createConnection(config)) {
            ...
            ValueFilter valueFilter1 = new ValueFilter(CompareFilter.CompareOp.EQUAL, new BinaryComparator(Bytes.toBytes("value-888")));
            ValueFilter valueFilter2 = new ValueFilter(CompareFilter.CompareOp.EQUAL, new BinaryComparator(Bytes.toBytes("value-999")));
