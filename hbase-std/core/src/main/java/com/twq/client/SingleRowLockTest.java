...
public class SingleRowLockTest {
    public static void main(String[] args) throws IOException {
        ...
        try(Connection connection = ConnectionFactory.createConnection(config)) {
            ...
            Increment increment1 = new Increment(Bytes.toBytes("row-123")).addColumn(Bytes.toBytes(AdminTest.CF_DEFAULT), Bytes.toBytes("i"), 1);
            ...
            boolean result =
                    table.checkAndPut(Bytes.toBytes("row-987"), Bytes.toBytes(AdminTest.CF_DEFAULT), Bytes.toBytes("m"), null, put1);
