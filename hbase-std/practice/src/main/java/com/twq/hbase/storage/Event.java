...
public class Event extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Event(java.lang.CharSequence id, java.lang.CharSequence eventId, java.lang.CharSequence eventType, java.lang.CharSequence partName, java.lang.CharSequence partNumber, java.lang.Long version, java.lang.CharSequence payload) {
    this.id = id;
  ...
  public static com.twq.hbase.storage.Event.Builder newBuilder() {
    return new com.twq.hbase.storage.Event.Builder();
  }
  
  /** Creates a new Event RecordBuilder by copying an existing Builder */
  public static com.twq.hbase.storage.Event.Builder newBuilder(com.twq.hbase.storage.Event.Builder other) {
    return new com.twq.hbase.storage.Event.Builder(other);
  }
  
  /** Creates a new Event RecordBuilder by copying an existing Event instance */
  public static com.twq.hbase.storage.Event.Builder newBuilder(com.twq.hbase.storage.Event other) {
    return new com.twq.hbase.storage.Event.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Event>
    ...
    private Builder() {
      super(com.twq.hbase.storage.Event.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.twq.hbase.storage.Event.Builder other) {
      super(other);
    ...
    private Builder(com.twq.hbase.storage.Event other) {
            super(com.twq.hbase.storage.Event.SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'id' field */
    public com.twq.hbase.storage.Event.Builder setId(java.lang.CharSequence value) {
    ...
    public com.twq.hbase.storage.Event.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'eventId' field */
    public com.twq.hbase.storage.Event.Builder setEventId(java.lang.CharSequence value) {
    ...
    public com.twq.hbase.storage.Event.Builder clearEventId() {
      eventId = null;
    ...
    /** Sets the value of the 'eventType' field */
    public com.twq.hbase.storage.Event.Builder setEventType(java.lang.CharSequence value) {
    ...
    public com.twq.hbase.storage.Event.Builder clearEventType() {
      eventType = null;
    ...
    /** Sets the value of the 'partName' field */
    public com.twq.hbase.storage.Event.Builder setPartName(java.lang.CharSequence value) {
    ...
    public com.twq.hbase.storage.Event.Builder clearPartName() {
      partName = null;
    ...
    /** Sets the value of the 'partNumber' field */
    public com.twq.hbase.storage.Event.Builder setPartNumber(java.lang.CharSequence value) {
    ...
    public com.twq.hbase.storage.Event.Builder clearPartNumber() {
      partNumber = null;
    ...
    /** Sets the value of the 'version' field */
    public com.twq.hbase.storage.Event.Builder setVersion(long value) {
    ...
    public com.twq.hbase.storage.Event.Builder clearVersion() {
    ...
    /** Sets the value of the 'payload' field */
    public com.twq.hbase.storage.Event.Builder setPayload(java.lang.CharSequence value) {
    ...
    public com.twq.hbase.storage.Event.Builder clearPayload() {
      payload = null;
