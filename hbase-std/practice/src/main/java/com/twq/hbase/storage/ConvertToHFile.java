...
public class ConvertToHFile {
    ...
    public static class ConvertToHFilesMapper extends Mapper<LongWritable, Text, ImmutableBytesWritable, Cell> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            KeyValue kv = new KeyValue(rowKeyBytes, CF, Bytes.toBytes(line[1]), out.toByteArray()); // <6> 构造HFile中的KeyValue对象
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        HFileOutputFormat2.configureIncrementalLoad(job, table, connection.getRegionLocator(tableName)); //HBase提供的大部分配置
